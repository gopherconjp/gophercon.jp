---
name: playwrite
description: "Use when recording a Playwright-based Shorts video with scripts/playwrite. Covers virtual-clock animation sync, PC cursor click with real hover, and ffmpeg assembly."
---
